...
// -----
module {
  func.func @same_extract_merged_vf_0(%arg0: tensor<1xf32>, %arg1: tensor<1xf32>) -> (tensor<1xf32>, tensor<1xf32>) attributes {hivm.func_core_type = #hivm.func_core_type<AIV>, hivm.vector_function} {
    return %arg0, %arg1 : tensor<1xf32>, tensor<1xf32>
  }
  func.func @same_extract_main(%arg0: tensor<1xf32>, %arg1: tensor<1xf32>) -> (f32, f32) {
    %c0 = arith.constant 0 : index
    %0:2 = call @same_extract_merged_vf_0(%arg0, %arg1) {hivm.vector_function, no_inline, ptc_simdvf} : (tensor<1xf32>, tensor<1xf32>) -> (tensor<1xf32>, tensor<1xf32>)
    %extracted = tensor.extract %0#0[%c0] : tensor<1xf32>
    %extracted_0 = tensor.extract %0#1[%c0] : tensor<1xf32>
...
// -----
module {
  func.func @same_no_extract_merged_vf_0(%arg0: tensor<4xf32>, %arg1: tensor<4xf32>) -> (tensor<4xf32>, tensor<4xf32>) attributes {hivm.func_core_type = #hivm.func_core_type<AIV>, hivm.vector_function} {
  ...
  func.func @same_no_extract_main(%arg0: tensor<4xf32>, %arg1: tensor<4xf32>) -> (tensor<4xf32>, tensor<4xf32>) {
    %0:2 = call @same_no_extract_merged_vf_0(%arg0, %arg1) {hivm.vector_function, no_inline, ptc_simdvf} : (tensor<4xf32>, tensor<4xf32>) -> (tensor<4xf32>, tensor<4xf32>)
